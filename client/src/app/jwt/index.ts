...
public tokenStream: Observable<string>;
  ...
  //public apiendPoind  =   'https://192.168.123.223' ; 
...
public get(url: string, options?: RequestOptionsArgs): Observable<Response> {
 ...
 // return this.http.get( this.apiendPoind+url );
 let token: string | Promise<string> = this.config.tokenGetter();
 ...
 // return this.requestHelper({ body: '', method: RequestMethod.Get, url: this.apiendPoind+url }, options);
}
...
public put(url: string, body: any, options?: RequestOptionsArgs): Observable<Response> {
  return this.requestHelper({ body: body, method: RequestMethod.Put, url: this.apiendPoind+url }, options);
}

public delete(url: string, options?: RequestOptionsArgs): Observable<Response> {
  return this.requestHelper({ body: '', method: RequestMethod.Delete, url: this.apiendPoind+url }, options);
}

public patch(url: string, body: any, options?: RequestOptionsArgs): Observable<Response> {
  return this.requestHelper({ body: body, method: RequestMethod.Patch, url: this.apiendPoind+url }, options);
}

public head(url: string, options?: RequestOptionsArgs): Observable<Response> {
  return this.requestHelper({ body: '', method: RequestMethod.Head, url: this.apiendPoind+url }, options);
}

public options(url: string, options?: RequestOptionsArgs): Observable<Response> {
  return this.requestHelper({ body: '', method: RequestMethod.Options, url: this.apiendPoind+url }, options);
}
